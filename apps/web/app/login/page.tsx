    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex flex-1 bg-[#1a1d2e] relative overflow-hidden items-center justify-center flex-col gap-6 px-10">
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-5xl font-extrabold gradient-text tracking-tight">AMDOX ERP</h1>
      ...
      <div className="w-full lg:w-[440px] flex items-center justify-center p-8 lg:p-12 bg-white animate-slide-right">
        <div className="w-full max-w-[360px]">
          ...
          {error && (
            <div className="mb-4 bg-[#ffebe9] border border-[#e5484d]/20 text-[#e5484d] px-4 py-2.5 rounded-lg text-sm animate-slide-up">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="block text-[11px] font-semibold text-[#555] mb-1.5 uppercase tracking-wider">Work Email</label>
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                className="w-full px-3.5 py-2.5 border border-[#e0e5ef] rounded-lg text-sm text-[#1a1d2e] placeholder-[#aaa] focus:outline-none focus:border-[#4f6ef7] focus:ring-2 focus:ring-[#4f6ef7]/10 transition-all" required />
            </div>

            <div>
              <label className="block text-[11px] font-semibold text-[#555] mb-1.5 uppercase tracking-wider">Password</label>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-[12px] text-[#4f6ef7] cursor-pointer hover:underline">Forgot password?</span>
            </div>
            ...
            <div className="flex gap-3">
              <button type="button" className="flex-1 py-2.5 rounded-lg border border-[#e0e5ef] text-[12px] text-[#4f6ef7] font-medium hover:bg-[#4f6ef7]/5 transition-colors">🔵 Google</button>
              <button type="button" className="flex-1 py-2.5 rounded-lg border border-[#e0e5ef] text-[12px] text-[#4f6ef7] font-medium hover:bg-[#4f6ef7]/5 transition-colors">🟦 Azure AD</button>
            </div>
